...
public class CasCading_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 *  크기(저장공간) 작은 type의 변수에
		 *  크기가 큰 type의 변수 값을 복사 대입하는 경우
		 *  값을 잃을 수 있다
		 *  하지만 대입하고자 한다면 "강제 현 변환(CasCasding)"을 수행해야한다
		 *  강제 형 변환을 수행했을때 예측할 수 없는 결과가 나올수 있고
		 *  그 책임은 온전히 개발자에게 있다
		 */
		...
		/*
		 * 복합연산자가 포함된 식에서는 
		 * 실수값을 정수값에 대입하는것에 문법 오류가 나지 않는다
		 * 내부적으로 강제 형변환이 일어나기 떄문이다
		 * 값을 예측할수없고 논리적인 문제를 일으키지 않으려면
		 * "많은 값을 대입하여" 오류를 방지해야한다
		 */
		intNum1 = 0;
		intNum1 += 3.123123123;
