...
public class Var_02 { 
	public static void main(String[] args) { // main() 시작
		...
		// 2. intNum1에 저장된 숫자형 데이터를 문자열형 데이터로 바꾼다
		// 3. intNum2에 저장된 값을 읽어온다
		System.out.println("55 + 33 = " + "55" + intNum2) ;
		// 4. intNum2에 저장된 숫자형 데이터를 문자열형 데이터로 바꾼다
		...
		System.out.println("55 / 33 = " + (intNum1 / intNum2));
		/*
		 *  블럭({}) 내에서 선언하고 값이 할당된 변수가 있을떄
		 *  변수에서 값을 읽어 연산을 수행하는데
	 ...
	 */
	// System.out.println(intNum3); 사용불가코드
} //class Var_02가 끝나는곳
